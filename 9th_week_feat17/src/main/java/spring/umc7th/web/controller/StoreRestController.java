...
public class StoreRestController {
    ...
    public ApiResponse<StoreResponseDTO.MissionPreViewListDTO> getMissionListByStore(
            @ExistStore @PathVariable(name = "storeId") Long storeId,
            @CheckPage @RequestParam(name = "page") Integer page) {
        Integer validatedPage = checkPageValidator.validateAndTransformPage(page);
        Page<Mission> missionList = storeQueryService.getMissionList(storeId, validatedPage);
